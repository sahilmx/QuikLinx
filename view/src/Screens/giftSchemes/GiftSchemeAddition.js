...
export default function GiftSchemeAddition() {
  const navigate = useNavigate();

  const [schemeName, setSchemeName] = useState("");
  const [brandName, setCompanyEmail] = useState("");
  const [points, setCompanyPassword] = useState("");
    ...
    axios(config)
      .then(function (response) {
        ...
        respData.forEach((element) => {
          userRolesArray.push(element.name);
        });
  ...
  const addNewVendor = (e) => {
    ...
    if (
      ...
      if (document.getElementById("file").files[0]) {
        ...
        formData.append("g_name", schemeName);
        ...
        var config = {
          method: "post",
          url: "http://127.0.0.1:3003/api/gift/add",
          headers: {
            slug: tenant,
          },
          data: formData,
        ...
        <div className="col-lg-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <h4 className="card-title">Add New Gift</h4>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-md-6 my-1">
                    ...
                    <MultipleSelectChip
                      names={userRoles}
                      optName={"Select"}
                      setSelectedRewardifyOption={setSelectedUserRoles}
                    />
                    {/*
                    <select
                      className="js-example-basic-single w-100"
