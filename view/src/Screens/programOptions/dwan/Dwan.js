...
export default function Dwan() {
  ...
  useEffect(() => {
    ...
    var config = {
      method: "get",
      url: "http://127.0.0.1:3003/admin/dwan/get",
      headers: {
  ...
  useEffect(() => {
    if (selectedVendor != 0) {
      var config = {
        method: "get",
        url: `http://127.0.0.1:3003/admin/dwanUsage/${selectedVendor}`,
        headers: {
          'Authorization': 'Bearer '+sessionStorage.getItem('access_token'), 
  ...
  const handleAddingRewardifyUsage = () => {
    if (!usagePresent) {
      ...
      var config = {
        method: "post",
        url: "http://127.0.0.1:3003/admin/dwanUsage/add",
        headers: {
          slug: tenant,
          "Content-Type": "application/json",
          'Authorization': 'Bearer '+sessionStorage.getItem('access_token'), 
    ...
    <div className="main-wrapper">
      <div className="page-content">
        <div className="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 className="mb-3 mb-md-0">Welcome to DWAN</h4>
          </div>
          <div className="d-flex align-items-center flex-wrap text-nowrap">
          {
            ...
            onClick={() => navigate("/addNewDwanOption")}
          >
            Add New Options
          </button>
  }
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Options for DWAN</h4>
