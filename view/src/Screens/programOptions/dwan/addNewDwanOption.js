...
export default function AddNewDwanOption() {
  ...
  const handleAddingNewRewardifyOption = () => {
    ...
    var config = {
      method: "post",
      url: "http://127.0.0.1:3003/admin/dwan/add",
      headers: {
        "Content-Type": "application/json",
        'Authorization': 'Bearer '+sessionStorage.getItem('access_token'), 
      },
  ...
  const updateToDb = (key, id, newSubOptions) => {
    ...
    var config = {
      method: "put",
      url: `http://127.0.0.1:3003/admin/dwan/${id}`,
      headers: {
        "Content-Type": "application/json",
        'Authorization': 'Bearer '+sessionStorage.getItem('access_token'), 
        ...
        <div className="row">
          ...
          <div className="col-6">
            <input
              ...
              onChange={(e) => setNewOptionValue(e.target.value)}
              placeholder="add new sub option value"
            />
          </div>
          <div className="col-3">
            <button
